...
| `docs/` | Architecture docs, UX design, Bruno API collection, feature documents |
| `docs/features/` | Feature documents (spec, plan, tasks, implementation) |
...
*Change reason: Feature folder moved to docs/features/; .github/workflows/ added to folder structure*
